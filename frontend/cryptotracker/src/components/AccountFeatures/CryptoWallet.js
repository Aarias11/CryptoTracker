...
const CryptoWallet = () => {
  return (
    <div className="w-full h-auto md:h-[400px]">
      ...
      <p className="mt-4 w-auto lg:w-[570px] ">It looks like you don't have a wallet connected yet. Add an external crypto wallet to your account to easily manage your assets, track investments, and streamline transactions. Connect your wallet now to enjoy a seamless crypto experience!</p>
